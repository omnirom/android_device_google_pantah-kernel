...
#define VCPU_CONTEXT 384 /* offsetof(struct kvm_vcpu, arch.ctxt) */
#define VCPU_FAULT_DISR 2288 /* offsetof(struct kvm_vcpu, arch.fault.disr_el1) */
#define VCPU_HCR_EL2 2232 /* offsetof(struct kvm_vcpu, arch.hcr_el2) */
